...
// Create new task
router.post('/', (0, validator_1.validateDto)(task_dto_1.CreateTaskDto), taskController.createTask.bind(taskController));
/**
...
// Update a task
router.patch('/:id', (0, validator_1.validateDto)(task_dto_1.UpdateTaskDto), taskController.updateTask.bind(taskController));
// Delete a task
